...
const NewsLetter = () => {
  return (
    <div className=" relative   ">
      <div className="flex flex-col  lg:flex-row font-integral justify-between py-[32px] lg:py-[36px] px-[24px] lg:px-[64px] bg-black rounded-3xl lg:mx-auto h-[300px] min-[420px]:h-[270px] md:h-[240px] lg:h-[200px] z-10 mx-4 max-w-[calc(1536px-120px)] ">
