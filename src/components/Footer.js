      ...
      <div className="bg-[#F0F0F0] ">
        <div className="relative text-[14px] text-grey/95 px-[16px] xxl:max-w-screen-xxl xxl:px-20 z-10 max-w-screen-2xl mx-auto">
          <div className="flex flex-col justify-between   lg:flex-row lg:justify-normal z-20 xxl:items-center">
            <div className="flex flex-col text-left py-[40px] px-[20px] gap-5 border-b-[1px] lg:w-[30%]  lg:border-b-0 xxl:px-[40px] xxl:w-[521px] xxl:py-[80px]">
            ...
            <div className="flex flex-row py-[40px] px-[60px] justify-around  w-full  lg:gap-[60px] xxl:gap-[100px]">
              <div className="flex flex-col justify-between w-[35%] items-center  gap-[40px] lg:flex-row lg:items-start lg:gap-[60px] xxl:gap-[100px]">
                <NavSection
                  title="Company"
