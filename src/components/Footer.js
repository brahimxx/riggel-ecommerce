      ...
      <div className="bg-[#F0F0F0] ">
        <div className="relative text-[14px] text-grey/95 px-[16px] xxl:max-w-screen-xxl xxl:px-20 z-10 max-w-screen-2xl mx-auto">
          <div className="flex flex-col justify-between   md:flex-row md:justify-normal z-20 xxl:items-center">
            <div className="flex flex-col text-left py-[30px] md:py-[40px] px-[20px] gap-1 md:gap-5  md:w-[30%]  md:border-b-0 xxl:px-[40px] xxl:w-[521px] xxl:py-[80px]">
              <span className="font-integral text-[34px] font-semibold whitespace-nowrap ">
                SHOP.CO
              </span>
              <span className="text-gray-500 md:text-[14px] ">
            ...
            <div className="flex flex-row py-[40px] px-4 lg:px-[60px] justify-center gap-10 md:justify-around  w-full lg:gap-[60px] xxl:gap-[100px]">
              <div className="flex flex-col justify-between w-[35%]  gap-[40px] md:flex-row md:items-start lg:gap-[60px] xxl:gap-[100px]">
                <NavSection
                  title="Company"
              ...
              <div className="flex flex-col items-center justify-between w-[35%] gap-[40px] md:flex-row md:items-start lg:gap-[60px] xxl:md:gap-[100px]">
                <NavSection
                  title="FAQ"
